...
const SESSION_TEMPLATES = [
  { title: "Saturday morning canvass",          types: ["canvass"],                  context: "general_campaigning", duration: 180, capacity: 20  },
  { title: "Evening leaflet drop",              types: ["leaflet"],                  context: "general_campaigning", duration: 120, capacity: null },
  { title: "GOTV door-knock — final push",      types: ["canvass", "gotv"],          context: "by_election",         duration: 180, capacity: 30  },
  { title: "Phone bank session",                types: ["phone_bank"],               context: "by_election",         duration: 120, capacity: 15  },
  { title: "Committee room open day",           types: ["committee_room"],           context: "local_election",      duration: 360, capacity: null },
  { title: "Weekday lunchtime canvass",         types: ["canvass"],                  context: "general_campaigning", duration: 90,  capacity: 10  },
  { title: "Targeted swing-voter canvass",      types: ["canvass"],                  context: "general_election",    duration: 180, capacity: 30  },
  { title: "GOTPV postal-vote phone bank",      types: ["phone_bank", "gotpv"],      context: "by_election",         duration: 120, capacity: 15  },
  { title: "Coffee morning and street stall",   types: ["other"],                    context: "membership_drive",    duration: 120, capacity: null },
  { title: "Town centre leafleting",            types: ["leaflet"],                  context: "local_election",      duration: 90,  capacity: 12  },
  { title: "Doorknock — priority wards",        types: ["canvass"],                  context: "local_election",      duration: 180, capacity: 20  },
  { title: "GOTV phone bank — pledge chase",    types: ["phone_bank", "gotv"],       context: "by_election",         duration: 120, capacity: 10  },
  { title: "Saturday volunteer training",       types: ["other"],                    context: "general_campaigning", duration: 90,  capacity: 30  },
  { title: "Selection hustings — meet the members", types: ["committee_room"],       context: "selection_contest",   duration: 120, capacity: null },
  { title: "Weekend canvass — student wards",   types: ["canvass"],                  context: "general_election",    duration: 240, capacity: 25  },
  { title: "Leaflet + canvass — rural villages", types: ["canvass", "leaflet"],      context: "general_campaigning", duration: 180, capacity: null },
  { title: "Phone bank — postal vote chase",    types: ["phone_bank", "gotpv"],      context: "general_election",    duration: 120, capacity: 15  },
  { title: "Wednesday morning canvass",         types: ["canvass"],                  context: "mayoral_election",    duration: 120, capacity: 15  },
  { title: "Sunday afternoon leaflet",          types: ["leaflet"],                  context: "general_campaigning", duration: 120, capacity: null },
  { title: "Committee room open evening",       types: ["committee_room"],           context: "local_election",      duration: 180, capacity: null },
];
