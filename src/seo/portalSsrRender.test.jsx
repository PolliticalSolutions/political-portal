...
describe("portal SSR render", () => {
  it("renders /portal/subscriptions without throwing", async () => {
    ...
    await expect(render("/portal/subscriptions")).resolves.toMatchObject({
      appHtml: expect.any(String),
      headHtml: expect.any(String),
    });

    const result = await render("/portal/subscriptions");
